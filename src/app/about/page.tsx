...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "kshitij.vasule@email.com",
    href: "mailto:kshitij.vasule@email.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/kshitijvasule/",
    content: "/kshitijvasule",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/kshitijvasule",
    content: "/kshitijvasule",
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Kshitij Vasule, a Comp. Sci. Engineer with 1.5 year experience in Development, DevOps and 
