    ...
    <section id="projects" className="max-w-7xl mx-auto md:h-[130vh]">
      <Link href={"#projects"}>
        <div className="relative mb-3 flex items-center justify-center w-full">
          ...
          <h2
            className={cn(
              "bg-gradient-to-r from-blue-400 via-purple-400 to-green-300 bg-[length:200%_200%] bg-clip-text text-transparent z-50 relative drop-shadow-[0_4px_24px_rgba(0,0,0,0.45)] animate-fade-in-up animate-gradient-move text-4xl text-center md:text-7xl pt-16",
              "mb-32"
            )}
          >
            Projects
